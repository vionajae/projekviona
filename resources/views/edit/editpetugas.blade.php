    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
		  <div class="header"> 
            ...
            <form action="{{url('/admin/edit/'.$data->id_petugas)}}" method="post">
                @csrf
            <div id="page-inner"> 
              <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <form role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_petugas" value="{{$data->nama_petugas}}" placeholder="Nama Petugas">
                                        </div>
                                        <div class="form-group">
                                            <label>Level</label>
